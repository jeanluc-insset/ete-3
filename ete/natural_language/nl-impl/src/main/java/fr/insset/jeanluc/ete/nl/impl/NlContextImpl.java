...
// import fr.insset.jeanluc.ete.nl.AttributeNav;
...
public class NlContextImpl implements NlContext<NlExpression> {



    public NlContextImpl(EteModel inModel, MofClass inContextualClass, NamedElement inContext) {
