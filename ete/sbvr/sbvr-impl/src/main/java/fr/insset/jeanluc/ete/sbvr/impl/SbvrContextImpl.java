...
// import fr.insset.jeanluc.ete.sbvr.AttributeNav;
...
public class SbvrContextImpl implements SbvrContext<SbvrExpression> {



    public SbvrContextImpl(EteModel inModel, MofClass inContextualClass, NamedElement inContext) {
