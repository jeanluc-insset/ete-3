...
//============================================================================//
// This lexer provides the default rules for all OCL based languages,         //
// including pseudo natural languages.                                        //
// To achieve this goal, the lexer provides two navigation rules :            //
// - leftToRightNavigation (such as OCL or Japanese)                          //
// - rightToLeftNavigation (such as French, Spanish)                          //
//============================================================================//
