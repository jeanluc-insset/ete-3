...
import fr.insset.jeanluc.ete.sbvr.Literal;
...
public class FloatingPointLiteralImpl  extends fr.insset.jeanluc.ete.sbvr.impl.LiteralImpl  implements FloatingPointLiteral {
