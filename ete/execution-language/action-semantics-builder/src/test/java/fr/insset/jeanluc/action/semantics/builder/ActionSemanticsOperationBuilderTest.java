...
public class ActionSemanticsOperationBuilderTest {
     ...
     */
    @Test
    public void testEnableActionSemantics() throws EteException, InstantiationException, IllegalAccessException, ClassNotFoundException {
...
//        PrimitiveDataTypes.init(parent);
        ...
        MofOperation calculeNote = passageClass.getOwnedOperation("calculeNote");
