...
public class JavaGeneratorTest {
    ...
    public final String     MODEL_PATH = "../../../src/test/mda/models/QCM_complet.xml";
    ...
    /*
//    @Test
    public void testGenerateJava() throws EteException, InstantiationException, IllegalAccessException, UnsupportedEncodingException, FileNotFoundException, IllegalArgumentException, InvocationTargetException {
...
//        ActionSemanticsUtil.init();
        ...
        // 4- generate classes with operation bodies
...
//        action.addParameter("output_base", "target/test/generated-sources/ete/");
        action.addParameter("output_base", "../as-target/target/generated-sources/ete/");
        ...
        Iterable<? extends JavaFileObject> compilationUnit
                ...
                JavaCompiler.CompilationTask task = compiler.getTask(
                    ...
                    optionList, 
                    null, 
                    compilationUnit);        // 5-2 instantiate some classes
