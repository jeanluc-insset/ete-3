 ...
 * references.<br>
 * Holds the same getters and methods than the Earning class.
 *
 * @author jldeleage
 */
public class OptionalEarning extends fr.upjv.mis.jl.ete.example.airways.model.OptionalEarningBurning  {


    public static OptionalEarning ofNullable(Earning inDelegate) {
        OptionalEarning result = new OptionalEarning();
