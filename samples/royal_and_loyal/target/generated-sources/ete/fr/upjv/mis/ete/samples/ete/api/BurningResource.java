...
@Stateless
@Path("burning")
public class BurningResource {


    @EJB
    BurningJpa       ejbFacade;
    ...
    public void create(Burning entity) {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, Burning entity) {
    ...
    public Burning find(@PathParam("id") Long id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Burning> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
