...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Service.findByTransactions", query = "SELECT f FROM Service f WHERE f.transactions = :param"),
    @NamedQuery(name = "Service.findAll", query = "SELECT f FROM Service f")
})
