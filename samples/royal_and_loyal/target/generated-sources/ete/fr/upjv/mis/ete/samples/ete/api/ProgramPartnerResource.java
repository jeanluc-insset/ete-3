...
@Stateless
@Path("programPartner")
public class ProgramPartnerResource {


    @EJB
    ProgramPartnerJpa       ejbFacade;
    ...
    public void create(ProgramPartner entity) {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, ProgramPartner entity) {
    ...
    public void remove(@PathParam("id") Long id) {
        ProgramPartnerJpa  facade = getFacade();
    ...
    public ProgramPartner find(@PathParam("id") Long id) {
    ...
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<ProgramPartner> findAll() {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<ProgramPartner> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
