...
@Stateless
@Path("loyaltyAccount")
public class LoyaltyAccountResource {


    @EJB
    LoyaltyAccountJpa       ejbFacade;
    ...
    public void create(LoyaltyAccount entity) {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, LoyaltyAccount entity) {
    ...
    public void remove(@PathParam("id") Long id) {
        LoyaltyAccountJpa  facade = getFacade();
    ...
    public LoyaltyAccount find(@PathParam("id") Long id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<LoyaltyAccount> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
