...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Earning.findByAccount", query = "SELECT f FROM Earning f WHERE f.account = :param"),
    @NamedQuery(name = "Earning.findAll", query = "SELECT f FROM Earning f")
})
public class Earning extends fr.upjv.mis.jl.ete.example.airways.model.EarningBurning  implements Serializable {
