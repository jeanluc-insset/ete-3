...
public class LoyaltyProgramResource {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, LoyaltyProgram entity) {
    ...
    public void remove(@PathParam("id") Long id) {
        LoyaltyProgramJpa  facade = getFacade();
    ...
    public LoyaltyProgram find(@PathParam("id") Long id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<LoyaltyProgram> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
