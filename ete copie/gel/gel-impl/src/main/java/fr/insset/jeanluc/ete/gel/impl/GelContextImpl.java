...
*/
     ...
     */
    @Override
    public GelExpression resolve(String inString) {
        try {
            GelExpression obj = __resolve(inString);
            return obj;
        } catch (InstantiationException | IllegalAccessException ex) {
...
*/
    ...
    public   GelExpression resolveOperation(String inString, MofType from) {
