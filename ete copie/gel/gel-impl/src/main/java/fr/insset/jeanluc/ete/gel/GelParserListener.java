...
public interface GelParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GelParser#primitive}.
	 * @param ctx the parse tree
	 */
	void enterPrimitive(GelParser.PrimitiveContext ctx);
	/**
	 * Exit a parse tree produced by {@link GelParser#primitive}.
	 * @param ctx the parse tree
	 */
	void exitPrimitive(GelParser.PrimitiveContext ctx);
	/**
	 * Enter a parse tree produced by {@link GelParser#attributeNavAtPreOrNot}.
	 * @param ctx the parse tree
	 */
	void enterAttributeNavAtPreOrNot(GelParser.AttributeNavAtPreOrNotContext ctx);
	/**
	 * Exit a parse tree produced by {@link GelParser#attributeNavAtPreOrNot}.
	 * @param ctx the parse tree
	 */
	void exitAttributeNavAtPreOrNot(GelParser.AttributeNavAtPreOrNotContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GelParser#collectionMethodNavExpression}.
	 * @param ctx the parse tree
	 */
	void enterCollectionMethodNavExpression(GelParser.CollectionMethodNavExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link GelParser#collectionMethodNavExpression}.
	 * @param ctx the parse tree
	 */
