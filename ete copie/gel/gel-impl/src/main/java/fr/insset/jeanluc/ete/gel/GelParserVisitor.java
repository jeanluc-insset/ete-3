...
public interface GelParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link GelParser#primitive}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrimitive(GelParser.PrimitiveContext ctx);
	/**
	 * Visit a parse tree produced by {@link GelParser#attributeNavAtPreOrNot}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAttributeNavAtPreOrNot(GelParser.AttributeNavAtPreOrNotContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link GelParser#collectionMethodNavExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
