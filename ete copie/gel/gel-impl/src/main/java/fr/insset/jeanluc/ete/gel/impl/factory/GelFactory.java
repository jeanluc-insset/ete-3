...
public class GelFactory {
    ...
    public static void registerFactories() {
        ...
        registry.registerDefaultFactory("return",
                    fr.insset.jeanluc.ete.gel.impl.ReturnImpl.class);        
        registry.registerDefaultFactory("<>",
        ...
        registry.registerDefaultFactory("???",
                    fr.insset.jeanluc.ete.gel.impl.AddOrSubImpl.class);        
        registry.registerDefaultFactory("->",
