...
public class TreeBuilder extends GelParserBaseVisitor<GelExpression> {
    ...
    public TreeBuilder(GelContext inContext) {
        ...
        registry.registerDefaultFactory("return", ReturnImpl.class);
        ...
        registry.registerDefaultFactory("???", AddOrSubImpl.class);
        ...
        registry.registerDefaultFactory("???", OperationImpl.class);
        registry.registerDefaultFactory("*", MultImpl.class);
        registry.registerDefaultFactory("???", MultOrDivImpl.class);
