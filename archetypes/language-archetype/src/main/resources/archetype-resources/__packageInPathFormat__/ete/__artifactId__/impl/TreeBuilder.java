...
import ${package}.${artifactId}.GelParserBaseVisitor;
import ${package}.${artifactId}.CollectionOperationExpression;
import ${package}.${artifactId}.GelExpression;
import ${package}.${artifactId}.Literal;
import ${package}.${artifactId}.Navigable;
import ${package}.${artifactId}.Navigation;
// import static ${package}.${artifactId}.api.Navigation.NAVIGATION;
import ${package}.${artifactId}.Operation;
import ${package}.${artifactId}.Self;
import ${package}.${artifactId}.VariableDefinition;
import ${package}.${artifactId}.VariableReference;
...
GelExpressionContext ctx                = parser.${artifactId}Expression();
TreeBuilder          treeBuilder        = new TreeBuilder(inContext);
GelExpression        abstractExpression = treeBuilder.visitGelExpression(ctx);
</pre></code>
 *
 */
@Generated("ete - jean-luc@insset.fr  modules/maven-project/${artifactId}-impl/java/tree-builder.vm")
