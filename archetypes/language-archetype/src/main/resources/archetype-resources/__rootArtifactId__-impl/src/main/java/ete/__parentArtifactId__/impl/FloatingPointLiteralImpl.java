...
import ${package}.ete.${parentArtifactId}.Literal;
...
public class FloatingPointLiteralImpl  extends ${package}.ete.${parentArtifactId}.impl.LiteralImpl  implements FloatingPointLiteral {
