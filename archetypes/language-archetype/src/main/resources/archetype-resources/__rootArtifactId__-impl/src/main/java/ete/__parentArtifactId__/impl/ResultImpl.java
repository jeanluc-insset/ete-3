...
import ${package}.ete.${parentArtifactId}.VariableReference;
...
public class ResultImpl  extends ${package}.ete.${parentArtifactId}.impl.VariableReferenceImpl  implements Result {
