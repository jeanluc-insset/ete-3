...
import ${package}.ete.${parentArtifactId}.OclFinalOperation;
...
public class OclIsTypeOfImpl  extends ${package}.ete.${parentArtifactId}.impl.OclFinalOperationImpl  implements OclIsTypeOf {
